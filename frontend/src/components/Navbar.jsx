        ...
        <nav className="navbar shadow-md sticky top-0 z-50 rounded-sm mb-5">
            <div className="max-w-7xl mx-auto px-6 py-1 flex justify-between items-center" >
                ...
                <ul className="flex space-x-6 items-center m-0">
                    ...
                    <li className="bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-200 shadow-lg hover:shadow-purple-500/50 flex items-center space-x-2 px-3 py-2 mx-3">{Auth.userAuth.user === null ? <Link to="/login"> {"Admin Login"}</Link> : <Link to="/dashboard"> {Auth.userAuth.user}</Link>}</li>
