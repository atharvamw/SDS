        ...
        <div className="pt-20 sm:pt-24 pb-8 sm:pb-16 px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-gray-300 text-lg max-w-2xl mx-auto leading-relaxed"> {/* Removed style, added leading-relaxed */}
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="group bg-slate-800/50 backdrop-blur-lg border border-purple-500/20 rounded-xl p-6 text-center hover:border-purple-400/40 hover:scale-105 hover:shadow-xl hover:shadow-purple-500/30 transition-all duration-300 cursor-pointer">
                ...
                <h3
                  className="text-2xl font-bold text-white mb-3" // Matched size from Home.jsx
                  style={{ fontFamily: "Orbitron, sans-serif" }}
                >
                  Email
                </h3>
                <a
                  ...
                  className="text-gray-400 group-hover:text-purple-400 transition-colors text-sm leading-relaxed" // Matched size/font
                >
                  sds@coep.ac.in
                </a>
              </div>
              ...
              <div className="group bg-slate-800/50 backdrop-blur-lg border border-purple-500/20 rounded-xl p-6 text-center hover:border-purple-400/40 hover:scale-105 hover:shadow-xl hover:shadow-purple-500/30 transition-all duration-300 cursor-pointer">
                ...
                <h3
                  className="text-2xl font-bold text-white mb-3" // Matched size
                  style={{ fontFamily: "Orbitron, sans-serif" }}
                >
                  Phone
                </h3>
                <p className="text-gray-400 text-sm leading-relaxed"> {/* Matched size/font */}
                  +91 1234567890
                </p>
              </div>
